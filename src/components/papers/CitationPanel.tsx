...
<head>
  <meta charset="UTF-8"/>
  <title>Researchly — References (${fmtLabel})</title>
  <style>
...
<body>
  <div class="page">
    ...
    ${rows}
    <div class="footer">
      <span>Generated by Researchly &nbsp;·&nbsp; Academic Research Assistant</span>
  ...
  return (
    <div style={{ padding:14 }}>
      ...
      {/* Preview */}
      <div style={{ background:"var(--bg)", border:"1px solid var(--border)", borderRadius:8, padding:10, maxHeight:110, overflowY:"auto", marginBottom:12 }}>
        <pre style={{ fontFamily:"var(--font-mono)", fontSize:10, color:"var(--text-secondary)", whiteSpace:"pre-wrap", lineHeight:1.6 }}>
          {text.slice(0, 380)}{text.length > 380 ? "…" : ""}
        </pre>
      </div>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:6 }}>
        ...
        <div style={{ display:"flex", gap:6 }}>
          <button onClick={copy} className="btn btn-outline" style={{ flex:1, padding:"7px 8px", fontSize:11.5 }}>
            {ok ? <Check size={11}/> : <Copy size={11}/>}
            {ok ? "Copied!" : "Copy"}
          </button>
          <button onClick={dlText} className="btn btn-outline" style={{ flex:1, padding:"7px 8px", fontSize:11.5 }}>
            <Download size={11}/>
        ...
        <p style={{ fontSize:10, color:"var(--text-faint)", textAlign:"center", lineHeight:1.4 }}>

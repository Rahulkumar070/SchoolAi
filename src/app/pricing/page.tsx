...
const PLANS = [
  {
    ...
    iconC: "var(--text-muted)",
    priceC: "var(--text-primary)",
    features: [
      "5 AI searches / day",
  ...
  return (
    <>
      ...
      <div style={{ background: "var(--bg)", minHeight: "100vh" }}>
        ...
        <div
          style={{ maxWidth: 980, margin: "0 auto", padding: "60px 20px 72px" }}
        >
          {/* Header */}
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            >
              Pay instantly — UPI, card, net banking. No emails, no waiting.
              Powered by Razorpay.
            </p>
              ...
              return (
                <div
                  ...
                  style={{
                    background: plan.highlight
                      ? "var(--surface)"
                      : "var(--bg-overlay)",
                    border: `${plan.highlight ? "1.5px" : "1px"} solid ${plan.highlight ? "var(--brand-border)" : "var(--border)"}`,
                    borderRadius: 16,
                    padding: 28,
                    display: "flex",
                ...
                >
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      if (!busy && plan.highlight)
                        (
                          e.currentTarget as HTMLButtonElement
                        ).style.background = "#d4903a";
                    }}
                    onMouseLeave={(e) => {
                      if (plan.highlight)
                        (
          ...
          <div style={{ maxWidth: 700, margin: "0 auto" }}>
            ...
            >
              {[
                {
                  q: "Is payment secure?",
                  a: "All payments processed by Razorpay — PCI-DSS certified, used by Zomato, Swiggy, 5M+ businesses.",
                },
                {
                  q: "Can I cancel anytime?",
                  a: "Yes. Cancel from your dashboard. Plan stays active until the billing period ends, then reverts to Free.",
                },
                {
                  q: "Does it auto-renew?",
                  a: "Yes, monthly. You'll get an email before each charge. Unsubscribe anytime in one click.",
                },
                {
                  q: "Do you store card details?",
                  a: "No. Razorpay handles all card data securely. We never see your payment information.",
                },
                {
                  q: "What if my payment fails?",
                  a: "Razorpay retries automatically. If it keeps failing, email us at hello.researchly@gmail.com.",
                },
                {
                  q: "Is there a student discount?",
                  a: "₹199/mo is already our student-friendly price. Email us at hello.researchly@gmail.com with your college ID for special rates.",
                },
              ].map(({ q, a }) => (
                <div key={q}>
                  <p
        ...
        >
          ...
          >
            <ShieldCheck size={11} style={{ color: "var(--green)" }} /> Payments
            secured by Razorpay
          </span>
        </footer>
      </div>

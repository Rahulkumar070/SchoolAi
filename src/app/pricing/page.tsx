      ...
      <div style={{ background:"var(--bg)", minHeight:"100vh" }}>
        ...
        <nav className="landing-nav">
          <Link href="/" style={{ display:"flex", alignItems:"center", gap:9, textDecoration:"none" }}>
            ...
            <span style={{ fontWeight:700, fontSize:14, color:"var(--text-primary)" }}>Researchly</span>
          </Link>
          ...
          <div style={{ maxWidth:700, margin:"0 auto" }}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(280px,1fr))", gap:"20px 36px" }}>
              {[
                ...
                { q:"What if my payment fails?",       a:"Razorpay retries automatically. If it keeps failing, email us at hello@researchly.in." },
        ...
        <footer style={{ borderTop:"1px solid var(--border)", padding:"16px 24px", display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:8 }}>
          <span style={{ fontSize:11.5, color:"var(--text-faint)" }}>© 2026 Researchly · Made in India 🇮🇳</span>

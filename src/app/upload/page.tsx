...
import { FileText, Upload, ArrowUp, X, Lock, BookOpen, User, AlertCircle, MessageSquare } from "lucide-react";
    ...
    <div style={{ padding:14, display:"flex", flexDirection:"column", gap:12 }}>
      ...
      {!session ? (
        <div style={{ padding:12, background:"var(--brand-dim)", border:"1px solid var(--brand-border)", borderRadius:9 }}>
          ...
          <p style={{ fontSize:11, color:"var(--text-secondary)", marginBottom:9, lineHeight:1.5 }}>PDF chat needs a free account</p>
          <Link href="/auth/signin" className="btn btn-brand" style={{ width:"100%", justifyContent:"center", textDecoration:"none", padding:"7px 10px", fontSize:12 }}>Sign In Free</Link>
        </div>
      ) : !file ? (
